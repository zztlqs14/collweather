...
import com.zhangke.shizhong.page.plan.WenduActivity;
import com.zhangke.shizhong.page.plan.cheshiActivity;
...
public class SettingFragment extends BaseFragment {
    ...
    @OnClick({R.id.tv_android_links,R.id.tv_android_zhinanzheng})
    public void onViewClick(View view) {
        switch (view.getId()) {
            case R.id.tv_android_links:{
                startActivity(new Intent(mActivity, WenduActivity.class));
                break;
            }
            case R.id.tv_android_zhinanzheng:{
                startActivity(new Intent(mActivity, cheshiActivity.class));
                break;
            }
        }
    }
